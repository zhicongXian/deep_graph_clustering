...
python3 ./main_with_smac.py --dataset=SeNet --data_path=./datasets/affinity_matrix_from_senet_sparse.npz --label_path=./datasets/senet_label.csv>> output_main_lsenet_hpo.txt
# ./cuda_application
