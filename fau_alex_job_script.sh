...
python3 ./main.py --dataset=SeNet --data_path=./datasets/affinity_matrix_from_senet_sparse_1000.npz --label_path=./datasets/senet_label_1000.csv >> output_main_lsenet_2.txt
# ./cuda_application
